<?php
// animals_new_fixed.php - API mới với các trường tương thích ngược
...
// Test trực tiếp nếu file được gọi trực tiếp
    ...
    try {
        ...
        if ($result['success']) {
            echo json_encode([
                ...
                'message' => 'API working correctly with backward compatibility'
            ], JSON_PRETTY_PRINT);
        } else {
            echo json_encode([
                'success' => false,
